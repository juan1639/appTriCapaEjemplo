...
public class PresentacionPruebas {
	...
	private final static DaoEmpleado dao = new DaoEmpleadoTreeMap();
	...
	public static void main(String[] args) {
		...
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					PresentacionPruebas window = new PresentacionPruebas();
